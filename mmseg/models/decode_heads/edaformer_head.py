...
class EDAFormerHead(BaseDecodeHead):
    def __init__(self, reduction_ratios, embed_dim, mlp_ratio, **kwargs):
        ...
        self.attn4 = Block(dim1=c4_in_channels, num_heads=8, mlp_ratio=mlp_ratio, drop_path=0.1,
                           pool_ratio=reduction_ratios[2])
        self.attn44 = Block(dim1=c4_in_channels, num_heads=8, mlp_ratio=mlp_ratio, drop_path=0.1,
                            pool_ratio=reduction_ratios[2])
        self.attn444 = Block(dim1=c4_in_channels, num_heads=8, mlp_ratio=mlp_ratio, drop_path=0.1,
                             pool_ratio=reduction_ratios[2])

        self.attn3 = Block(dim1=c3_in_channels, num_heads=4, mlp_ratio=mlp_ratio, drop_path=0.1,
                           pool_ratio=reduction_ratios[1] * 2)
        self.attn33 = Block(dim1=c3_in_channels, num_heads=4, mlp_ratio=mlp_ratio, drop_path=0.1,
                            pool_ratio=reduction_ratios[1] * 2)

        self.attn2 = Block(dim1=c2_in_channels, num_heads=2, mlp_ratio=mlp_ratio, drop_path=0.1,
                           pool_ratio=reduction_ratios[0] * 4)
