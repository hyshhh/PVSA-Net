_base_ = [
    # '../_base_/models/models/biformer_mm_base.py',
    # '../_base_/models/biformer_fusion.py',
    '../_base_/models/VTFormer-s.py',
    # '../_base_/models/VTFormer-l.py',
    # '../_base_/models/models/biformer_mm_base.py',
    # '../_base_/models/models/seaformer-l.py',
    # '../_base_/models/models/seaformer.py',
    ...
    # '../_base_/models/models/vwformer_bi.py',
    # '../_base_/models/deeplabv3plus_r50-d8.py',
    # '../_base_/models/RMT_fpn.py',
    # '../_base_/models/fpn_poolformer_s12.py',
    # '../_base_/models/models/twins_pcpvt-s_upernet.py',
